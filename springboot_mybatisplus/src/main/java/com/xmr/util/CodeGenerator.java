...
public class CodeGenerator {
    ...
    private static void fastAutoGenerator() {
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1/test?characterEncoding=utf8&serverTimezone=UTC&useSSL=false", "root", "9958")
...
//                            .enableSwagger() // 开启 swagger 模式
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("user", "sys_role") // 设置需要生成的表名
                            .addTablePrefix("sys_"); // 设置过滤表前缀,会把表前缀给删除掉,例如t_user,生成的类是User
                })
